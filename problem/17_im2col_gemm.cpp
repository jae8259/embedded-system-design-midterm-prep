...
// Transform input [C][H][W] into col matrix [C*K*K][OH*OW].
// For each output pixel (oy,ox) and kernel tap (ci,ky,kx):
//   col[((ci*K+ky)*K+kx)*OH*OW + oy*OW+ox] = input[(ci*H+oy+ky)*W+ox+kx]
