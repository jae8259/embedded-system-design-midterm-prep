...
// TODO: parallelize depthwise convolution with OpenMP.
// Each channel c is completely independent (no shared output writes).
// Hint: #pragma omp parallel for schedule(static) on the c-loop.
